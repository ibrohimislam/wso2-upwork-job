...
module.exports = (config) => ({
  ...
  app: {
    ...
    name: env.APP_NAME || 'eHealth',

    // Your application description.
    // This will be used as your description meta tag
    description: env.APP_DESCRIPTION || 'eHealth is a digital medical record serving Indonesia',
    ...
    autoprefix: env.APP_AUTOPREFIX || config.production,
  },
